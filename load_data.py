...
if opt.MFPT_data:
    # Normal data ###############################################
    baseline_1 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/1 - Three Baseline Conditions/baseline_1.mat')[0][0][1])
    baseline_2 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/1 - Three Baseline Conditions/baseline_2.mat')[0][0][1])
    baseline_3 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/1 - Three Baseline Conditions/baseline_3.mat')[0][0][1])
    baseline_1_label = one_hot(0, 3)
    baseline_2_label = one_hot(0, 3)
    baseline_3_label = one_hot(0, 3)
    
    # Outer rate ################################################
    OuterRaceFault_1 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/2 - Three Outer Race Fault Conditions/OuterRaceFault_1.mat')[0][0][2])
    OuterRaceFault_2 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/2 - Three Outer Race Fault Conditions/OuterRaceFault_2.mat')[0][0][2])
    OuterRaceFault_3 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/2 - Three Outer Race Fault Conditions/OuterRaceFault_3.mat')[0][0][2])
    OuterRaceFault_vload_1 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/3 - Seven More Outer Race Fault Conditions/OuterRaceFault_vload_1.mat')[0][0][2])
    OuterRaceFault_vload_2 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/3 - Seven More Outer Race Fault Conditions/OuterRaceFault_vload_2.mat')[0][0][2])
    OuterRaceFault_vload_3 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/3 - Seven More Outer Race Fault Conditions/OuterRaceFault_vload_3.mat')[0][0][2])
    OuterRaceFault_vload_4 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/3 - Seven More Outer Race Fault Conditions/OuterRaceFault_vload_4.mat')[0][0][2])
    OuterRaceFault_vload_5 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/3 - Seven More Outer Race Fault Conditions/OuterRaceFault_vload_5.mat')[0][0][2])
    OuterRaceFault_vload_6 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/3 - Seven More Outer Race Fault Conditions/OuterRaceFault_vload_6.mat')[0][0][2])
    OuterRaceFault_vload_7 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/3 - Seven More Outer Race Fault Conditions/OuterRaceFault_vload_7.mat')[0][0][2])
    ...
    # Inter rate ###################################################################################################################################
    InnerRaceFault_vload_1 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/4 - Seven Inner Race Fault Conditions/InnerRaceFault_vload_1.mat')[0][0][2])
    InnerRaceFault_vload_2 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/4 - Seven Inner Race Fault Conditions/InnerRaceFault_vload_2.mat')[0][0][2])
    InnerRaceFault_vload_3 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/4 - Seven Inner Race Fault Conditions/InnerRaceFault_vload_3.mat')[0][0][2])
    InnerRaceFault_vload_4 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/4 - Seven Inner Race Fault Conditions/InnerRaceFault_vload_4.mat')[0][0][2])
    InnerRaceFault_vload_5 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/4 - Seven Inner Race Fault Conditions/InnerRaceFault_vload_5.mat')[0][0][2])
    InnerRaceFault_vload_6 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/4 - Seven Inner Race Fault Conditions/InnerRaceFault_vload_6.mat')[0][0][2])
    InnerRaceFault_vload_7 = divide_sample(scipy.io.loadmat('/content/drive/Shareddrives/newpro112233/signal_machine/MFPT Fault Data Sets/4 - Seven Inner Race Fault Conditions/InnerRaceFault_vload_7.mat')[0][0][2])
