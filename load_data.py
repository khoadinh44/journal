...
# Normal_0_X097_FE_time = Fourier(f=Normal_0_X097_FE_time, num=num, get_PSD=True, thres=25)
...
# B007_0_X122_DE_time = Fourier(f=B007_0_X122_DE_time, num=num, get_result=True, thres=5)
# B007_0_X122_FE_time = Fourier(f=B007_0_X122_FE_time, num=num, get_PSD=True, thres=5)
...
# IR007_0_X122_DE_time = Fourier(f=IR007_0_X122_DE_time, num=num, get_result=True, thres=5)
# IR007_0_X122_FE_time = Fourier(f=IR007_0_X122_FE_time, num=num, get_PSD=True, thres=5)
...
# OR007_3_0_X122_DE_time = Fourier(f=OR007_3_0_X122_DE_time, num=num, get_result=True, thres=5)
# OR007_3_0_X122_FE_time = Fourier(f=OR007_3_0_X122_FE_time, num=num, get_PSD=True, thres=5)
...
# OR007_6_0_X122_DE_time = Fourier(f=OR007_6_0_X122_DE_time, num=num, get_result=True, thres=5)
# OR007_6_0_X122_FE_time = Fourier(f=OR007_6_0_X122_FE_time, num=num, get_PSD=True, thres=5)
...
# OR007_12_0_X122_DE_time = Fourier(f=OR007_12_0_X122_DE_time, num=num, get_result=True, thres=5)
# OR007_12_0_X122_FE_time = Fourier(f=OR007_12_0_X122_FE_time, num=num, get_PSD=True, thres=5)
