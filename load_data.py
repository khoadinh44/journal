...
'''
Normal_0 = concatenate_data(scipy.io.loadmat('./data/normal/Normal_0.mat'), scale=StandardScaler())
Normal_0_label = one_hot(0, 64)
Normal_1 = concatenate_data(scipy.io.loadmat('./data/normal/Normal_1.mat'), scale=StandardScaler())
Normal_1_label = one_hot(1, 64)
Normal_2 = concatenate_data(scipy.io.loadmat('./data/normal/Normal_2.mat'), scale=StandardScaler())
Normal_2_label = one_hot(2, 64)
Normal_3 = concatenate_data(scipy.io.loadmat('./data/normal/Normal_3.mat'), scale=StandardScaler())
Normal_3_label = one_hot(3, 64)

B007_0 = concatenate_data(scipy.io.loadmat('./data/12k/B007_0.mat'), scale=StandardScaler())
B007_0_label = one_hot(4, 64)
B007_1 = concatenate_data(scipy.io.loadmat('./data/12k/B007_1.mat'), scale=StandardScaler())
B007_1_label = one_hot(5, 64)
B007_2 = concatenate_data(scipy.io.loadmat('./data/12k/B007_2.mat'), scale=StandardScaler())
B007_2_label = one_hot(6, 64)
B007_3 = concatenate_data(scipy.io.loadmat('./data/12k/B007_3.mat'), scale=StandardScaler())
B007_3_label = one_hot(7, 64)

B014_0 = concatenate_data(scipy.io.loadmat('./data/12k/B014_0.mat'), scale=StandardScaler())
B014_0_label = one_hot(8, 64)
B014_1 = concatenate_data(scipy.io.loadmat('./data/12k/B014_1.mat'), scale=StandardScaler())
B014_1_label = one_hot(9, 64)
B014_2 = concatenate_data(scipy.io.loadmat('./data/12k/B014_2.mat'), scale=StandardScaler())
B014_2_label = one_hot(10, 64)
B014_3= concatenate_data(scipy.io.loadmat('./data/12k/B014_3.mat'), scale=StandardScaler())
B014_3_label = one_hot(11, 64)

B021_0 = concatenate_data(scipy.io.loadmat('./data/12k/B021_0.mat'), scale=StandardScaler())
B021_0_label = one_hot(12, 64)
B021_1 = concatenate_data(scipy.io.loadmat('./data/12k/B021_1.mat'), scale=StandardScaler())
B021_1_label = one_hot(13, 64)
B021_2 = concatenate_data(scipy.io.loadmat('./data/12k/B021_2.mat'), scale=StandardScaler())
B021_2_label = one_hot(14, 64)
B021_3 = concatenate_data(scipy.io.loadmat('./data/12k/B021_3.mat'), scale=StandardScaler())
B021_3_label = one_hot(15, 64)

B028_0 = concatenate_data(scipy.io.loadmat('./data/12k/B028_0.mat'), scale=StandardScaler())
B028_0_label = one_hot(16, 64)
B028_1 = concatenate_data(scipy.io.loadmat('./data/12k/B028_1.mat'), scale=StandardScaler())
B028_1_label = one_hot(17, 64)
B028_2 = concatenate_data(scipy.io.loadmat('./data/12k/B028_2.mat'), scale=StandardScaler())
B028_2_label = one_hot(18, 64)
B028_3 = concatenate_data(scipy.io.loadmat('./data/12k/B028_3.mat'), scale=StandardScaler())
B028_3_label = one_hot(19, 64)

IR007_0 = concatenate_data(scipy.io.loadmat('./data/12k/IR007_0.mat'), scale=StandardScaler())
IR007_0_label = one_hot(20, 64)
IR007_1 = concatenate_data(scipy.io.loadmat('./data/12k/IR007_1.mat'), scale=StandardScaler())
IR007_1_label = one_hot(21, 64)
IR007_2 = concatenate_data(scipy.io.loadmat('./data/12k/IR007_2.mat'), scale=StandardScaler())
IR007_2_label = one_hot(22, 64)
IR007_3 = concatenate_data(scipy.io.loadmat('./data/12k/IR007_3.mat'), scale=StandardScaler())
IR007_3_label = one_hot(23, 64)

IR014_0 = concatenate_data(scipy.io.loadmat('./data/12k/IR014_0.mat'), scale=StandardScaler())
IR014_0_label = one_hot(24, 64)
IR014_1 = concatenate_data(scipy.io.loadmat('./data/12k/IR014_1.mat'), scale=StandardScaler())
IR014_1_label = one_hot(25, 64)
IR014_2 = concatenate_data(scipy.io.loadmat('./data/12k/IR014_2.mat'), scale=StandardScaler())
IR014_2_label = one_hot(26, 64)
IR014_3 = concatenate_data(scipy.io.loadmat('./data/12k/IR014_3.mat'), scale=StandardScaler())
IR014_3_label = one_hot(27, 64)

IR021_0 = concatenate_data(scipy.io.loadmat('./data/12k/IR021_0.mat'), scale=StandardScaler())
IR021_0_label = one_hot(28, 64)
IR021_1 = concatenate_data(scipy.io.loadmat('./data/12k/IR021_1.mat'), scale=StandardScaler())
IR021_1_label = one_hot(29, 64)
IR021_2 = concatenate_data(scipy.io.loadmat('./data/12k/IR021_2.mat'), scale=StandardScaler())
IR021_2_label = one_hot(30, 64)
IR021_3 = concatenate_data(scipy.io.loadmat('./data/12k/IR021_3.mat'), scale=StandardScaler())
IR021_3_label = one_hot(31, 64)

IR028_0 = concatenate_data(scipy.io.loadmat('./data/12k/IR028_0.mat'), scale=StandardScaler())
IR028_0_label = one_hot(32, 64)
IR028_1 = concatenate_data(scipy.io.loadmat('./data/12k/IR028_1.mat'), scale=StandardScaler())
IR028_1_label = one_hot(33, 64)
IR028_2 = concatenate_data(scipy.io.loadmat('./data/12k/IR028_2.mat'), scale=StandardScaler())
IR028_2_label = one_hot(34, 64)
IR028_3 = concatenate_data(scipy.io.loadmat('./data/12k/IR028_3.mat'), scale=StandardScaler())
IR028_3_label = one_hot(35, 64)

OR007_12_0 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@12_0.mat'), scale=StandardScaler())
OR007_12_0_label = one_hot(36, 64)
OR007_12_1 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@12_1.mat'), scale=StandardScaler())
OR007_12_1_label = one_hot(37, 64)
OR007_12_2 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@12_2.mat'), scale=StandardScaler())
OR007_12_2_label = one_hot(38, 64)
OR007_12_3 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@12_3.mat'), scale=StandardScaler())
OR007_12_3_label = one_hot(39, 64)

OR007_3_0 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@3_0.mat'), scale=StandardScaler())
OR007_3_0_label = one_hot(40, 64)
OR007_3_1 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@3_1.mat'), scale=StandardScaler())
OR007_3_1_label = one_hot(41, 64)
OR007_3_2 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@3_2.mat'), scale=StandardScaler())
OR007_3_2_label = one_hot(42, 64)
OR007_3_3 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@3_3.mat'), scale=StandardScaler())
OR007_3_3_label = one_hot(43, 64)

OR007_6_0 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@6_0.mat'), scale=StandardScaler())
OR007_6_0_label = one_hot(44, 64)
OR007_6_1 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@6_1.mat'), scale=StandardScaler())
OR007_6_1_label = one_hot(45, 64)
OR007_6_2 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@6_2.mat'), scale=StandardScaler())
OR007_6_2_label = one_hot(46, 64)
OR007_6_3 = concatenate_data(scipy.io.loadmat('./data/12k/OR007@6_3.mat'), scale=StandardScaler())
OR007_6_3_label = one_hot(47, 64)

OR0014_6_0 = concatenate_data(scipy.io.loadmat('./data/12k/OR014@6_0.mat'), scale=StandardScaler())
OR0014_6_0_label = one_hot(48, 64)
OR0014_6_1 = concatenate_data(scipy.io.loadmat('./data/12k/OR014@6_1.mat'), scale=StandardScaler())
OR0014_6_1_label = one_hot(49, 64)
OR0014_6_2 = concatenate_data(scipy.io.loadmat('./data/12k/OR014@6_2.mat'), scale=StandardScaler())
OR0014_6_2_label = one_hot(50, 64)
OR0014_6_3 = concatenate_data(scipy.io.loadmat('./data/12k/OR014@6_3.mat'), scale=StandardScaler())
OR0014_6_3_label = one_hot(51, 64)

OR0021_6_0 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@6_0.mat'), scale=StandardScaler())
OR0021_6_0_label = one_hot(52, 64)
OR0021_6_1 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@6_1.mat'), scale=StandardScaler())
OR0021_6_1_label = one_hot(53, 64)
OR0021_6_2 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@6_2.mat'), scale=StandardScaler())
OR0021_6_2_label = one_hot(54, 64)
OR0021_6_3 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@6_3.mat'), scale=StandardScaler())
OR0021_6_3_label = one_hot(55, 64)

OR0021_3_0 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@3_0.mat'), scale=StandardScaler())
OR0021_3_0_label = one_hot(56, 64)
OR0021_3_1 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@3_1.mat'), scale=StandardScaler())
OR0021_3_1_label = one_hot(57, 64)
OR0021_3_2 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@3_2.mat'), scale=StandardScaler())
OR0021_3_2_label = one_hot(58, 64)
OR0021_3_3 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@3_3.mat'), scale=StandardScaler())
OR0021_3_3_label = one_hot(59, 64)

OR0021_12_0 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@12_0.mat'), scale=StandardScaler())
OR0021_12_0_label = one_hot(60, 64)
OR0021_12_1 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@12_1.mat'), scale=StandardScaler())
OR0021_12_1_label = one_hot(61, 64)
OR0021_12_2 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@12_2.mat'), scale=StandardScaler())
OR0021_12_2_label = one_hot(62, 64)
OR0021_12_3 = concatenate_data(scipy.io.loadmat('./data/12k/OR021@12_3.mat'), scale=StandardScaler())
