...
def network():
  ...
  hidden1 = keras.layers.Dense(300, activation=tf.keras.layers.ReLU(), kernel_regularizer='l1_l2', kernel_initializer="he_normal")(input_) # "lecun_normal"
  # hidden1 = keras.layers.AlphaDropout(rate=0.2)(hidden1),
  norm1 = keras.layers.BatchNormalization()(hidden1)
  hidden2 = keras.layers.Dense(100, activation=tf.keras.layers.ReLU(), kernel_regularizer='l1_l2', kernel_initializer="he_normal")(norm1)
