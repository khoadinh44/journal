...
def train_new_triplet_center(opt, x_train_scale, x_train, y_train, x_test_scale, x_test, y_test, network, i=100):
    ...
    # if os.path.exists(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/x_test_extract_{i}_CWRU_pow.npy'):
    #   x_train_extract = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/x_train_extract_{i}_CWRU_pow.npy')
    #   x_test_extract = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/x_test_extract_{i}_CWRU_pow.npy')
    # else:
...
#       x_test_extract  = scaler_transform(x_test_extract, PowerTransformer)
    ...
    if opt.scaler == 'MinMaxScaler':
      ...
      x_test_extract = scaler_transform(x_test_extract, scaler)
      ...
      # with open(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/x_train_extract_{i}_CWRU_pow.npy', 'wb') as f:
      #   np.save(f, x_train_extract)
      # with open(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/x_test_extract_{i}_CWRU_pow.npy', 'wb') as f:
    ...
    # # data-----------------------------------------------------
    # if os.path.exists(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/anchor_{i}_CWRU_pow.npy'):
    #   anchor_extract = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/anchor_extract_{i}_CWRU_pow.npy', mmap_mode="r")
    #   anchor = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/anchor_{i}_CWRU_pow.npy', mmap_mode="r")
    #   X_train = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/X_train_{i}_CWRU_pow.npy', mmap_mode="r")
    #   Y_train = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/Y_train_{i}_CWRU_pow.npy', mmap_mode="r")
    # else:
    ...
    if opt.scaler == 'handcrafted_features':
      ...
      # with open(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/anchor_{i}_CWRU_pow.npy', 'wb') as f:
      #   np.save(f, anchor)
      # with open(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/X_train_{i}_CWRU_pow.npy', 'wb') as f:
      #   np.save(f, X_train)
      # with open(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/Y_train_{i}_CWRU_pow.npy', 'wb') as f:
      #   np.save(f, Y_train)
    print(f'anchor shape: {anchor.shape}')
    print(f'anchor-extract shape: {anchor_extract.shape}\n')
    

    # if os.path.exists(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/positive_{i}_CWRU_pow.npy'):
    #   positive_extract = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/positive_extract_{i}_CWRU_pow.npy', mmap_mode="r")
    #   positive = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/positive_{i}_CWRU_pow.npy', mmap_mode="r")
    # else:
    ...
    if opt.scaler == 'handcrafted_features':
      ...
      # with open(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/positive_{i}_CWRU_pow.npy', 'wb') as f:
      #   np.save(f, positive)
    ...
    # if os.path.exists(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/negative_{i}_CWRU_pow.npy'):
    #   negative_extract = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/negative_extract_{i}_CWRU_pow.npy', mmap_mode="r")
    #   negative = np.load(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/negative_{i}_CWRU_pow.npy', mmap_mode="r")
    # else:
    ...
    if opt.scaler == 'handcrafted_features':
      ...
      # with open(f'/content/drive/Shareddrives/newpro112233/signal_machine/output_triplet_loss/negative_{i}_CWRU_pow.npy', 'wb') as f:
      #   np.save(f, negative)
